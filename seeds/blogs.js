    ...
    .then(function () {
      return Promise.all([
        ...
        knex('blogs').insert({
          ...
          content: `
          <h4 class="blog-title">EQ > IQ? It's not really news to me now.</h4>
          <h5>What learnings did you take from the chapter?</h5>
