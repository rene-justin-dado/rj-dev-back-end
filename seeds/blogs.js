    ...
    .then(function () {
      return Promise.all([
        ...
        knex('blogs').insert({
          ...
          content: {
            "title": "I'm taking the opportunity, on this fine, sunny Friday morning to stay inside and write this, my first ever blog post. These are just a few thoughts I have about EDA so far at the start of phase-0, with the lovely Nikau cohort.",
            "questions": ["What's your take on the DBC/EDA (Dev Bootcamp/Enspiral Dev Academy) experience?", "What are your impressions?"],
            "answers": ["To sum it up very simply, it seems to be a very community-centric type of system, not unlike a good (non-toxic) gaming community. Everyone will have their own skills and experiences to bring to the table and their own goals and motivations to work towards. However, I get the sense that, at least from what I got from my own cohort so far, we're all in it for the same reason at the end of the day. We're here to learn and we can lean on each other when it comes down to building our skills.", "I'm in love with the system already. It actually hits very close to home, I think. As a gamer, having been part of several gaming communities, I've drawn a few comparisons between EDA and the communities I've experienced. While the goal in gaming is mainly to have fun (unless you're <em>that</em> type of person... XD), part of the experience is learning the rules of a game, testing out new things and developing skills that are useful within the game world. EDA, I feel, seems to build a community where fun, experimentation and skill development are simply applied to the real world, rather than a virtual one."]
          }
        }),
        knex('blogs').insert({
          category: 'EDA culture',
        ...
        knex('blogs').insert({
          ...
          content: {
            "title": "EQ > IQ? It's not really news to me now.",
